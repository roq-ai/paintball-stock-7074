...
export function InventoryListPage(props: InventoryListPageProps) {
  ...
  const columns: ColumnType[] = [
    { id: 'paintballs_in_stock', header: 'paintballs_in_stock', accessorKey: 'paintballs_in_stock' },
    { id: 'paintballs_used', header: 'paintballs_used', accessorKey: 'paintballs_used' },
