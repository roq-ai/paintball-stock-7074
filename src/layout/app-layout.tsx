...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['store-manager', 'inventory-manager', 'sales-associate'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Sales', path: '/sales', entity: 'sales', service: AccessServiceEnum.PROJECT, icon: FiDollarSign },
